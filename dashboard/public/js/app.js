...
Livewire.on('laraveltable:action:confirm', function (actionType, actionIdentifier, modelPrimary, confirmationQuestion) {
...
Livewire.on('laraveltable:action:feedback', function (feedbackMessage) {
...
Livewire.on('laraveltable:link:open:newtab', function (url) {
